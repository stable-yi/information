...
@profile_blue.route('/baseinfo',methods=["POST","GET"])
@user_login_data
def base_info():
    """
    获取用户信息
...
def news_release():
    ...
    news.index_image_url = 'http://mmbiz-qpic.wallstcn.com/mmbiz_jpg/ac9HVYE3uMI1icProqPbLxa7EdqfL7gYE3k7Pq0GJIHibYq9Kgesg9dvdV0P0ADZepGcu7ic3QrVKlRa6GHMzdk6A/0?wx_fmt=jpeg'
